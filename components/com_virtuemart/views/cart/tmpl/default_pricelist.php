...
<tr>
	...
	<th
		align="center"
		width="60px"><?php echo JText::_ ('COM_VIRTUEMART_CART_MARIMEA') ?> </th>
	<th
		align="right"
...
<tr valign="top" class="sectiontableentry<?php echo $i ?> pdt_line">
	<td align="left">
		...
		<?php } ?>
		<?php echo JHTML::link ($prow->url, $prow->product_name, 'class="pdt_name"') . $prow->customfields; ?>

	</td>
	<td align="left" class="text-center"><?php  echo $prow->product_sku ?></td>
	<td align="center">
...
<form method="post" id="checkoutForm" name="checkoutForm" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=cart' . $taskRoute, $this->useXHTML, $this->useSSL); ?>">
	...
	<?php } ?>
<tr class="sectiontableentry1 no-padding" valign="top" >
...
<?php
	...
	?>
	<td class="no-padding" colspan="4" align="left">
		<?php echo $this->cart->cartData['shipmentName']; ?>
	</td>
	<?php } ?>
...
<tr class="sectiontableentry1 no-padding border-bottom" valign="top">
...
<tr class="sectiontableentry2 final-price-tb-tr">
        <td colspan="4" align="right" class="no-bg"></td>
	<td align="right" class="final-price-tb"><?php echo JText::_ ('COM_VIRTUEMART_CART_TOTAL') ?>:</td>
	...
	<td align="right" class="final-price-tb2"><div class="bold"><?php echo $this->currencyDisplay->createPriceDiv ('billTotal', '', $this->cart->pricesUnformatted['billTotal'], FALSE); ?></div></td>
</tr>
<?php
