...
/**
* @package	Wide Slide Module for Joomla!
* @author	Pixel Point Creative http://www.pixelpointcreative.com
* @copyright	Copyright (C) Pixel Point Creative. All rights reserved.
...
class JFormFieldUpgradecheck extends JFormField {
	...
	protected function getLabel()
	{
		...
		//If cURL is supported, check the current version available.
				...
				$version = 1.0;
				$target = 'http://www.pixelpointcreative.com/upgradecheck/wideslide/index.txt';
				$curl = curl_init();
				...
				if ($version < $str)
					...
					<a href="http://www.pixelpointcreative.com/downloads.html" target="_blank">Download Latest Version</a> &nbsp;&nbsp;|&nbsp; &nbsp;<a href="http://www.pixelpointcreative.com/support.html" target="_blank">Get Help</a> &nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.pixelpointcreative.com/changelogs/wideslide.txt" target="_blank">View the Changelog</a></label></div>';
				...
				echo'<div style="float:left;clear: both;"><img width="180" height="80" border="0" src="../modules/mod_wide_slide/elements/wide_slide_logo.png" title="Wide Slide" alt="Wide Slide"></div>';  
				return 
				$message;
